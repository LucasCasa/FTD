...
public class LevelManager {
	...
	public void loadPaths(){
		...
		case 1:
			Vector3[] aux1 = {new Vector3(0,350,2),new Vector3(290,350,2),new Vector3(290,620,3),new Vector3(690,620,2),new Vector3(690,190,0),new Vector3(1280,0,2)};
			Vector3[] aux2 = {new Vector3(0,300,2),new Vector3(320,300,2),new Vector3(320,590,3),new Vector3(650,590,2),new Vector3(650,150,0),new Vector3(1280,0,2)};
			GameEngine.getInstance().setPaths(aux2, aux1);
			break;
		case 2:
			Vector3[] aux3 = {new Vector3(0,420,2),new Vector3(320,420,2),new Vector3(320,204,0),new Vector3(506,204,2),new Vector3(506,492,3),new Vector3(752,492,2),new Vector3(752,276,0),new Vector3(1280,0,2)};
			Vector3[] aux4 = {new Vector3(0,370,2),new Vector3(290,370,2),new Vector3(290,154,0),new Vector3(536,154,2),new Vector3(536,442,3),new Vector3(722,442,2),new Vector3(722,226,0),new Vector3(1280,0,2)};
			GameEngine.getInstance().setPaths(aux4, aux3);
			break;
		case 3:
			Vector3[] aux5 = {new Vector3(360,720,0),new Vector3(360,600,0),new Vector3(160,600,1),new Vector3(160,180,0),new Vector3(1280,180,2)};
			Vector3[] aux6 = {new Vector3(390,720,0),new Vector3(390,600,0),new Vector3(740,600,2),new Vector3(740,410,0),new Vector3(450,410,1),new Vector3(450,-20,0)};
			GameEngine.getInstance().setPaths(aux5,aux6);
			break;
		case 4:
			Vector3[] aux7 = {new Vector3(0,410,2),new Vector3(220,410,2),new Vector3(220,615,3),new Vector3(810,615,2),new Vector3(810,130,0),new Vector3(1280,130,2)};
			...
			break;
		case 5:
			Vector3[] aux9 = {new Vector3(0,325,2),new Vector3(250,325,2),new Vector3(250,469,3),new Vector3(610,469,2),new Vector3(610,253,0),new Vector3(754,253,2),new Vector3(754,397,3),new Vector3(1042,397,2),new Vector3(1042,325,0),new Vector3(1280,0,2)};
			Vector3[] aux10 = {new Vector3(0,325,2),new Vector3(250,325,2),new Vector3(250,109,0),new Vector3(610,109,2),new Vector3(610,253,3),new Vector3(754,253,2),new Vector3(754,181,0),new Vector3(1042,181,2),new Vector3(1042,325,3),new Vector3(1280,0,2)};
		...
		case 6:
			...
			Vector3[] aux12 = {new Vector3(675,720,0),new Vector3(675,596,0),new Vector3(742,596,2),new Vector3(742,452,0),new Vector3(675,452,1),new Vector3(675,164,0),new Vector3(825,164,2),new Vector3(825,308,3),new Vector3(1105,308,2),new Vector3(1105,164,0),new Vector3(1280,0,2)};
